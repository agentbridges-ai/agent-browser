...
- `chrome-extension.manage`: inspect the optional Chrome extension bridge provider through `agent-browser plugin run chrome-extension chrome-extension.status`
