...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>AGENT_BROWSER_CHROME_BRIDGE_PORT</code></td><td>Local daemon port for the optional Chrome extension bridge provider.</td><td><code>19826</code></td></tr>
    <tr><td><code>AGENT_BROWSER_CHROME_BRIDGE_PROFILE</code></td><td>Profile id to use when multiple Chrome extension bridge profiles are connected.</td><td>Auto-selects one profile when possible</td></tr>
    <tr><td><code>AGENT_BROWSER_CHROME_BRIDGE_DAEMON</code></td><td>Override daemon executable path for the Chrome extension bridge provider.</td><td>Bundled daemon</td></tr>
    <tr><td><code>AGENT_BROWSER_CHROME_BRIDGE_EXTENSION_ID</code></td><td>Override the bundled Chrome extension id allowed to connect to the bridge daemon.</td><td><code>pimcamjccpkgapdpecfiadkemnggggbj</code></td></tr>
    <tr><td><code>AGENT_BROWSER_CHROME_BRIDGE_LOG</code></td><td>Optional daemon log file for the Chrome extension bridge provider.</td><td>No file logging</td></tr>
